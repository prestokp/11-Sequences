...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [99, 100, 83, 2, 7 , 96, 2, 19, 21]
    threshold = 20
    expected = 5
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def count_items_bigger_than(numbers, threshold):
    ...
    for k in range(len(numbers)):
        if threshold < numbers[k]:  #numbers represents the name of the sequence
            count = count + 1
    return count
...
def run_test_count_positive_sines():
    ...
    # Test 11
    expected = 2
    actual = count_positive_sines([1,2,3,4,5])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 113
    actual = sum_first_n([48,-10,50,5,20],5)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 3
    actual = sum_first_n([1,2,4,8,16],2)
    print()
    print('Test 9 expected:', expected)
    print('       actual   ', actual)
